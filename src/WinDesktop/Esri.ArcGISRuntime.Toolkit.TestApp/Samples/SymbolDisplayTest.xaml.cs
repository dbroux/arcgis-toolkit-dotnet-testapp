	...
	public partial class SymbolDisplayTest : Page
	{
		...
		public SymbolDisplayTest()
		{
			...
			SymbolInfos = new List<SymbolInfo>
			{
				...
				new SymbolInfo
				{
					Description = "SimpleMarkerSymbol Cross Size 50 with outline",
